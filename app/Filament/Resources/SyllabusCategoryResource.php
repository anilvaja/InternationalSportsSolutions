...
use App\Filament\Resources\SyllabusCategoryResource\Pages;

class SyllabusCategoryResource extends Resource
{
    protected static ?string $model = SyllabusCategory::class;
    protected static ?string $navigationIcon = 'heroicon-o-book-open';
    protected static ?string $navigationGroup = 'Academy';
    protected static ?string $slug = 'syllabus-categories';
    ...
    {
        return $table
            ->heading(fn () => 'Total Categories: ' . \App\Models\SyllabusCategory::count())
            ->columns([
    ...
    public static function getPages(): array
    {
        ...
        // getPagesNamespace override removed; correct use statement added above
}
