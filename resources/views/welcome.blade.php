...
<head>
    ...
    <title>International Sports Solutions</title>
    ...
    <style>
        ...
        .panel-title { font-size: 1.25rem; font-weight: 600; margin-bottom: 0.5rem; color: #f53003;}
        .panel-desc { font-size: 1rem; color: #555; margin-bottom: 1rem; }
        .panel-btn {
            background: #f53003; color: #fff; border: none; border-radius: 0.5rem;
            padding: 0.75rem 1.5rem; font-size: 1rem; font-weight: 500; cursor: pointer;
            transition: background 0.2s;
        }
        .panel-btn:hover { background: #c41e00; }
...
<body>
    <div class="center">
        <h1 style="font-size:2rem; font-weight:700; color:#f53003; margin-bottom:0.5rem;">
